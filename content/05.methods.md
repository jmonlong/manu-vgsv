...
We repeated the process with the same reads on the linear reference, using `bwa mem`[@arxiv:1303.3997] for mapping and Delly Genotyper, SVTyper and BayesTyper for SV genotyping.
