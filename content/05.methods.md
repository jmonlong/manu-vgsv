...
The algorithm proceeds through three main phases:
...
We obtained version 0.6 of the Genome in a Bottle (GIAB) SV VCF for the Ashkenazim son (HG002) from the NCBI FTP site.
...
As a proxy measure for precision, we considered variants without a determined genotype in the GIAB call set (14649 out of 74012) to be "false positives".
