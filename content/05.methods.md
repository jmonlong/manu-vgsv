...
The algorithm, illustrated in Figure {@fig:1}a, is as follows:
...
Covering relationships are used to define TPs, FPs, and FNs the same way as for deletions and insertions.
...
Version 0.5 of the Genome in a Bottle (GIAB) VCF containing SVs for the Ashkenazim son (HG002) and his parents was obtained from the NCBI FTP site.
