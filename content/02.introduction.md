...
Ineed, SVs have long been associated with developmental disorders, cancer and other complex diseases and phenotypes[@doi:10.1038/nrg3373], but remain much more poorly studied than their smaller mutational counterparts.
...
In some cases, SVs can be inferred indirectly from short read mappings via split reads and discordant read pairs, but the accuracy of such approaches remains limited[@tag:hgsvc].
