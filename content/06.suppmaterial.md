...
For deletions and inversions, we compute the proportion of a variant that is covered by a variant in the other set, considering only variants overlapping with at least 10% reciprocal overlap.
...
A similar approach is used for insertions, although they are first clustered is located at less than 20 bp from each other and their inserted sequences aligned to derive the coverage statistics.
The SV evaluation approach is described in more details in the [Methods](#toil-vg-sveval).
