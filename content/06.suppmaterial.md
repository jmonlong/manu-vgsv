...
|          | called in SMRT-SV v2     | INS  | 3410 | 3789 | 2108 |     0.478 |  0.618 | 0.539 |
|          |                       | DEL  | 2544 | 1092 | 1518 |     0.699 |  0.626 | 0.661 |
|          |                       | INV  |    8 |    8 |   52 |     0.500 |  0.133 | 0.210 |
|          | not called in SMRT-SV v2 | INS  | 4838 |  542 | 3678 |     0.899 |  0.568 | 0.696 |
...
|          | called in SMRT-SV v2     | INS  | 4343 | 5595 | 1175 |     0.445 |  0.787 | 0.569 |
|          |                       | DEL  | 3227 | 2451 |  835 |     0.573 |  0.794 | 0.666 |
|          | not called in SMRT-SV v2 | INS  |  116 |  109 | 8400 |     0.551 |  0.014 | 0.026 |
...
![**Calling evaluation on the CHM pseudo-diploid dataset.** The pseudo-diploid genome was built from CHM cell lines and used to train SMRT-SV v2 in Audano et al.[@tag:audano2019]](images/chmpd.png){#fig:chmpd tag="S9"}
...
SMRT-SV v2 required roughly 36 hours and 30G ram on 30 cores to genotype the three HGSVC samples on the "SVPOP" VCF.
These numbers are not directly comparable to the above table because 1) they apply to the "SVPOP" rather than "HGSVC" dataset (upon which we were unable to run SMRT-SV v2) and 2) we were unable to install SMRT-SV v2 on AWS nodes and ran it on an older, shared server at UCSC instead.
