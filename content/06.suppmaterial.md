...
![**Genotyping evaluation on the CHM pseudo-diploid dataset.** The pseudo-diploid genome was built from CHM cell lines and used to train SMRT-SV2 in Audano et al.[@tag:audano2019]](images/chmpd-geno.png){#fig:chmpd-geno tag="S8"}

![**Calling evaluation on the CHM pseudo-diploid dataset.** The pseudo-diploid genome was built from CHM cell lines and used to train SMRT-SV2 in Audano et al.[@tag:audano2019]](images/chmpd.png){#fig:chmpd tag="S9"}
