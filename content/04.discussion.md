...
Simulations showed that this approach can usually correct small errors in SV breakpoints (Additional File 1: Fig. {@fig:simerror-bkpt} and Additional File 1: Table {@tbl:simerror-bkpt}).
