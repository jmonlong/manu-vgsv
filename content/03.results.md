...
Sites of variation are then identified using the snarl (aka "bubble") graph decomposition as described in [@tag:snarls], each resulting site being represented as a subgraph of the larger graph.
...
A recent study by Audano et al. generated catalog of 97,368 SVs using long-read sequencing across 15 individuals[@tag:audano2019].
