...
The vg toolkit provides open source tools for constructing and mapping reads to such variation graphs [@tag:vgnbt].
...
Genome graphs can be constructed directly from multiple sequence alignments [@tag:vgnbt].
...
Furthermore, genome alignments from software such as Cactus [@doi:10.1101/gr.123356.111] can contain complex structural variation that is extremely difficult to represent outside of a graph, let alone call.
