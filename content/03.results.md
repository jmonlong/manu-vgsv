...
[//]: # (We are only talking about brakpoint location right? And not mutations in the breakpoint region?)
...
We evaluated the SV genotyping methods on this sample using the GIAB callset that also contains parental calls as input.
