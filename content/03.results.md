...
[//]: # (It might be worth mentioning why you only compare against SMRT-SV2 in this section and not other methods, delly etc.)
...
The first graph (called *VCF graph* below) was created from the linear reference genome of the *S.c. S288C* strain and a set of SVs relative to this reference strain in VCF format identified from other four assemblies by three methods: Assemblytics [@doi:10.1093/bioinformatics/btw369], AsmVar [@doi:10.1186/s13742-015-0103-4] and paftools [@doi:10.1093/bioinformatics/bty191].
...
[//]: # (From this its sounds like that you are only using SVs to construct the sample graphs. My understanding from the methods section was that the sample graphs also contained SNVs and indels.)
